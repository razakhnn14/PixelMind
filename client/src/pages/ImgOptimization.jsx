...
function ImgOptimization() {
  ...
  const handleSubmit = async () => {
    ...
    formData.append("width", width);
     ...
     try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/images/img-optimization`, formData,{
        headers:{
      ...
      <div className="w-full max-w-md bg-[#111] rounded-lg p-6 shadow-lg border border-purple-600">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full bg-black border border-purple-500 rounded-md px-3 py-2 text-white cursor-pointer"
          >
        ...
        <div className="mb-6">
          ...
          >
            ...
            <option value="auto:best">Best (Max Quality)</option>
